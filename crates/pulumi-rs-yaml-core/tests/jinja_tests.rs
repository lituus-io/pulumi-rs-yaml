...
"#,
    ...
    std::fs::write(
        sub.join("environment.j2"),
        r#"{% set bucket_list = [
{ "project_source": "example-project-pr-000000", "name": "sample-data-export-20260101", }
]%}"#,
    )
    .unwrap();
...
"#;
    ...
    assert!(
        result.contains("sample-data-export-20260101"),
        "stack.bucket_list should iterate, got:\n{}",
        result
    );
    assert!(
        result.contains("cheese_bucket_name_sample-data-export-20260101"),
